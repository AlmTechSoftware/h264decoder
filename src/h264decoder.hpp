 ...
 * My version of libav on ubuntu 16 appears to be from the release/11 branch on
 * github Video decoding example:
 * https://libav.org/documentation/doxygen/release/11/avcodec_8c_source.html#l00455
